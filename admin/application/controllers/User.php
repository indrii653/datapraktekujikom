...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Setting : Dashboard';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Setting : Add New User';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Setting : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'Setting : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Setting : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'Setting : My Profile' : 'Setting : Change Password';
